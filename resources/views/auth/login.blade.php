...
<div class="mx-auto flex w-full max-w-md flex-col gap-6">
    <div>
        <h1 class="text-2xl font-semibold tracking-tight text-rose-950">Welcome back</h1>
        <p class="mt-1 text-sm text-rose-700">Login to manage your todos.</p>
    </div>
    ...
    <div class="rounded-xl border border-rose-200 bg-white p-6 shadow-sm">
        ...
        <p class="mt-5 text-center text-sm text-rose-700">
            ...
            <a href="/register" class="font-semibold text-rose-950 hover:underline">Register</a>
        </p>
    </div>
</div>
@endsection
